// Logo officiel Slack (le « clover » multicolore), utilisé pour pointer vers
// l'installation Slack. Composant présentationnel pur (serveur ou client).
export default function SlackMark({ size = 18 }: { size?: number }) {
  return (
    <svg viewBox="0 0 122.8 122.8" width={size} height={size} aria-hidden="true" style={{ flex: "none" }}>
      <path
